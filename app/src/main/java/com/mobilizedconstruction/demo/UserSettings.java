...
public class UserSettings {
    ...
    private UserSettings(Context context) {
        syncManager = new CognitoSyncManager(context,
                IdentityManager.getDefaultIdentityManager().getUnderlyingProvider(),
                Application.awsConfiguration);
    }
    ...
    public Dataset getDataset() {
        return syncManager.openOrCreateDataset(USER_SETTINGS_DATASET_NAME);
    }

...
public class DemoSampleDataGenerator {
    ...
    /* package */
    static String getRandomPartitionSampleString(final String attributeName) {
    ...
    /* package */
    static Double getRandomSampleNumber() {
        return (double) SAMPLE_DATA_NUMBER_MIN + getRandomNumber();
    }

    /* package */
    static String getRandomSampleString(final String attributeName) {
    ...
    /* package */
    public static byte[] getRandomSampleBinary() {

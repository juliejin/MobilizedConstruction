    ...
    protected Object doInBackground(Object[] objects) {
        ...
        if(byGetOrPost == 0){
            try{
                ...
                String link = "http://10.0.2.2:8080/user_get.php?username="+username+"&password="+password;
            ...
            try{
                String username = (String)objects[0];
                String password = (String)objects[1];
                String link = "http://10.0.2.2:4000/user_put.php?username="+username+"&password="+password;
